    ...
    <section className="py-24 bg-cream-warm">
      <div className="container max-w-6xl">
        <div className="text-center mb-12">
          <div className="inline-block text-[11px] font-bold text-coral uppercase tracking-[0.2em]">The shift</div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl border border-charcoal/10 bg-white p-8">
            <div className="text-[11px] font-bold text-charcoal-muted uppercase tracking-[0.2em] mb-6">Old way</div>
          ...
          <div className="rounded-3xl border border-charcoal/10 bg-charcoal text-white p-8 relative overflow-hidden">
            ...
            <div className="relative">
              <div className="text-[11px] font-bold text-coral uppercase tracking-[0.2em] mb-6">HireIQ</div>
              <ul className="space-y-4">
                {newWay.map((item) => (
        ...
        <div className="mt-6 rounded-3xl border border-charcoal/10 bg-white p-8">
          <div className="grid sm:grid-cols-2 gap-8 items-center">
            <div>
              <div className="text-[11px] font-bold uppercase tracking-[0.2em] text-charcoal-muted mb-2">Traditional</div>
              <div className="font-display font-bold text-3xl text-charcoal mb-3">14 days</div>
            ...
            <div>
              <div className="text-[11px] font-bold uppercase tracking-[0.2em] text-coral mb-2">HireIQ</div>
              <div className="font-display font-bold text-3xl text-coral mb-3">4 hours</div>
