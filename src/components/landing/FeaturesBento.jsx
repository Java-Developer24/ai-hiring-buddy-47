    ...
    <section className="py-24 bg-cream">
      <div className="container max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-5">
            ...
            <div className="relative grid sm:grid-cols-2 gap-6 items-center">
              <div>
                ...
                <p className="mt-3 text-base text-white/70">
                  ...
                  against your JD — no two interviews are identical.
                </p>
              </div>
              <div className="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-5">
                ...
                <p className="text-sm text-white/90 leading-relaxed">
                  &ldquo;You mentioned scaling Postgres at TruePay. Walk me
                  through how you handled the read-replica lag during the Q3
                  launch.&rdquo;
                </p>
          ...
          <FeatureCard
            icon={FileSearch}
            title="Resume × JD match scoring"
            body="Semantic match, not keyword counting."
          />
          <FeatureCard
            icon={Workflow}
            title="Autonomous outcome actions"
            body="Auto-reject, auto-invite, auto-shortlist on your rules."
          />
          <FeatureCard
            icon={Code2}
            title="Coding & skills assessments"
            body="Live sandbox with anti-cheat, scored automatically."
          />
          <FeatureCard
            icon={ShieldCheck}
            title="Audit trail & compliance"
            body="Every decision logged. EEOC-ready exports."
          />
        </div>
      </div>
    </section>
