        ...
        <div className="bg-white border border-charcoal/10 rounded-[24px] p-6 shadow-sm flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="text-center">
              ...
              <div className="mt-1 px-2 py-0.5 rounded bg-[#E5F9F1] text-[#00CC88] text-[9px] font-black tracking-widest uppercase">
                SHORTLIST
              </div>
          ...
          <div className="col-span-12 lg:col-span-7 space-y-6">
            ...
            <div className="bg-white border border-charcoal/10 rounded-[24px] p-6 shadow-sm space-y-5">
              ...
              <div className="flex items-start gap-4">
                <div className="px-4 py-1.5 rounded-lg bg-[#E5F9F1] text-[#00CC88] text-xs font-black tracking-wider shrink-0 mt-1">
                  SHORTLIST
                </div>
              ...
              <div className="p-5 space-y-4">
                <div className="space-y-2">
                  <div className="flex gap-2 items-center">
                    <span className="h-4 px-1 rounded bg-[#E8EDFF] text-[#2D5BFF] text-[8px] font-bold flex items-center">
                      BEHAVIOURAL
                    </span>
