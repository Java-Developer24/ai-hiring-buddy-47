  ...
  const candidates = [
    {
      ...
      name: "Jordan Mehta",
      initial: "JS",
      color: "bg-[#E5F9F1] text-[#00CC88]",
      score: 84,
      resume: 81,
      video: 88,
      stage: "Shortlisted",
      verdict: "SHORTLIST",
      verdictColor: "bg-[#E5F9F1] text-[#00CC88]",
      flags: 0,
      applied: "2d",
    },
    {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-2">
                ...
                <span className="px-2 py-0.5 rounded-md bg-[#E8EDFF] text-[#2D5BFF] text-[10px] font-bold uppercase tracking-wider">
                  Senior
                </span>
                <span className="px-2 py-0.5 rounded-md bg-white border border-charcoal/10 text-charcoal-muted text-[10px] font-bold uppercase tracking-wider">
                  Remote
            ...
            <tbody>
              {candidates.map((c) => (
                ...
                >
                  ...
                  <td className="px-3 py-4">
                    <span
                      className={`text-[12px] font-medium ${c.stage === "Shortlisted" ? "text-[#00CC88]" : c.stage === "Rejected" ? "text-[#FF4D4D]" : "text-charcoal"}`}
                    >
                      {c.stage}
                    </span>
                  </td>
