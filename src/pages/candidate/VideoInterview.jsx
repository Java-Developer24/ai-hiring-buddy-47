            ...
            <div className="space-y-8">
              <div className="flex items-center justify-center gap-4 mb-4">
                ...
                <div className="flex gap-1">
                  {interviewQuestions.map((_, i) => (
                    <div
                      key={i}
                      className={`h-1 w-4 rounded-full ${i + 1 <= currentQuestion ? "bg-coral" : "bg-white/10"}`}
                    />
                  ))}
                </div>
              </div>
              <div className="relative h-40 w-40 mx-auto flex items-center justify-center">
                ...
                <div className="text-center">
                  <span className="text-5xl font-display font-bold text-white block">
                    {countdown}
                  </span>
            ...
            <div className="space-y-6 pt-4">
              ...
              <div className="space-y-6 rounded-[24px] border border-coral/20 bg-gradient-to-br from-coral/10 via-white/5 to-amber/10 p-6 backdrop-blur-sm">
                <div className="space-y-1.5">
                  <p className="text-xs font-bold text-amber uppercase tracking-widest">
                    Submission complete
                  </p>
