      ...
      <div className="w-full max-w-[460px] bg-white border border-charcoal/10 rounded-[28px] p-8 shadow-xl relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[13px] text-charcoal-muted mt-2">
            Sign in to view jobs, mailbox updates, and application tracking
          </p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="text-[10px] text-amber font-bold hover:underline"
              >
                Forgot?
              </button>
            </div>
          ...
          <button
            type="submit"
            className="w-full h-11 mt-2 rounded-xl bg-coral text-white font-bold text-sm hover:bg-coral-dark transition-all shadow-lg shadow-coral/20 active:scale-[0.98]"
          >
            Sign in
          </button>
        </form>
