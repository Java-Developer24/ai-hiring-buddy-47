        ...
        <div className="max-w-[1040px] mx-auto bg-white border border-charcoal/10 rounded-3xl p-8 md:p-10 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3 items-stretch">
            {stages.map((s, i) => (
              <div
                key={s.title}
                className="relative bg-cream border border-charcoal/10 rounded-2xl p-4 flex flex-col items-center text-center"
              >
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm bg-charcoal rounded-full py-3 px-6">
            <span className="text-white/70">
              <b className="text-white">48</b> applied
            </span>
            <span className="text-white/30">·</span>
            <span className="text-white/70">
              <b className="text-white">27</b> auto-rejected
            </span>
            <span className="text-white/30">·</span>
            <span className="text-white/70">
              <b className="text-amber">9</b> shortlisted
            </span>
            <span className="text-white/30">·</span>
            <span className="text-white/70">
              <b className="text-white">3</b> in review
            </span>
          </div>
        </div>
      </div>
