...
const FloatingCard = ({ name, role, side, delay }) => (
  <div
  ...
  >
    ...
    <div>
      <div className="text-lg font-semibold text-charcoal leading-tight">
        {name}
      </div>
      ...
      <div className="container relative">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <p className="mt-6 text-lg sm:text-lg text-charcoal-muted max-w-2xl">
            HireIQ screens every resume, runs the video interview, scores every
            answer, and shortlists the best candidates — fully autonomously. You
