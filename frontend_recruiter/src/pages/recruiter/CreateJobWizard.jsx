                      ...
                      <div className="space-y-6 animate-in fade-in duration-700">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="px-1.5 py-0.5 rounded bg-plum/10 text-plum text-[9px] font-bold">
                              AI GENERATED
                            </span>
                          </div>
                          <div className="space-y-3">
                            <div className="flex gap-3 items-start">
                              <span className="h-5 px-1.5 rounded bg-[#E8EDFF] text-[#2D5BFF] text-[9px] font-bold flex items-center shrink-0">
                                BEHAVIOURAL
                              </span>
                  ...
                  <div className="space-y-5 rounded-2xl border border-charcoal/10 bg-cream/30 p-6">
                    ...
                    <div className="rounded-xl border border-charcoal/10 bg-white p-4 space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="rounded-full bg-[#E8EDFF] px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-[#2D5BFF]">
                          Backend preset
                        </span>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="h-8 w-full rounded-full flex overflow-hidden border border-charcoal/5">
                        ...
                        <div className="h-full bg-[#E5F9F1] w-[35%] flex items-center justify-center">
                          <span className="text-[8px] font-bold text-[#00CC88] uppercase">
                            Auto-shortlist
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="rounded-xl border border-charcoal/10 bg-white p-4 space-y-3">
                        ...
                        <div className="space-y-2 text-[11px] leading-5 text-charcoal-muted">
                          ...
                          <div className="rounded-lg bg-[#E5F9F1] px-3 py-2 text-[#11805A]">
