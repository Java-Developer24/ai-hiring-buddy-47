  ...
  return (
    ...
    >
      ...
      <div className="bg-amber-soft/90 border-b border-amber-warm/10 py-1.5 px-8 flex items-center justify-center gap-2 flex-none">
        ...
        <p className="text-[9px] font-bold text-charcoal/70 uppercase tracking-widest">
        ...
        <div className="flex-1 flex overflow-hidden rounded-[28px] border border-charcoal/10 shadow-sm bg-white">
          ...
          <div className="w-[42%] bg-white border-r border-charcoal/10 overflow-y-auto p-8 space-y-8">
            <div className="space-y-4">
              <span className="text-[10px] font-bold text-charcoal-muted uppercase tracking-widest block">
                Problem 1
              </span>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 rounded-full bg-coral/10 text-coral text-[10px] font-bold uppercase tracking-wider">
                  45 min round
                </span>
                <span className="px-3 py-1 rounded-full bg-amber-soft text-amber text-[10px] font-bold uppercase tracking-wider">
                  Database systems
                </span>
              </div>
            </div>
            ...
            <div className="space-y-6 text-sm text-charcoal leading-relaxed">
              <p>
                Given a{" "}
                <code className="bg-cream px-1.5 py-0.5 rounded font-mono">
                  users
                </code>{" "}
                table with 10 million rows, write a SQL query that efficiently
                retrieves all users who registered in the last 30 days, ordered
                by registration date descending.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 bg-cream/30 border border-charcoal/5 rounded-xl font-mono text-[12px] text-charcoal-muted">
                  ...
                  <p>
                    users table with columns: id, email, created_at, status...
                  </p>
                </div>
                <div className="p-4 bg-cream/30 border border-charcoal/5 rounded-xl font-mono text-[12px] text-charcoal-muted">
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-xs font-medium text-charcoal-muted">
                  <li className="flex items-center gap-2">
                    <div className="h-1 w-1 rounded-full bg-coral" /> Use
                    PostgreSQL syntax
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="h-1 w-1 rounded-full bg-coral" /> Query must
                    use index if available
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="h-1 w-1 rounded-full bg-coral" /> Handle 10M
                    rows efficiently
                  </li>
                </ul>
              </div>
