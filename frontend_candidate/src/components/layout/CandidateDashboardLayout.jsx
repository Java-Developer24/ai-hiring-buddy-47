  ...
  return (
    <div className="min-h-screen flex bg-cream font-sans">
      ...
      <aside className="w-64 bg-white border-r border-charcoal/10 flex flex-col px-4 py-6 gap-2 fixed inset-y-0 left-0 z-50 shadow-sm">
        ...
        <div className="px-3 mt-4 mb-2 text-[10px] uppercase tracking-wider text-charcoal-muted font-bold">
          Candidate Portal
        </div>
        ...
        <div className="bg-cream/50 rounded-2xl p-4 border border-charcoal/5 flex flex-col gap-3">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-charcoal text-white flex items-center justify-center text-sm font-bold flex-none shadow-sm">
              JD
            </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="inline-flex items-center gap-2 h-10 px-3 rounded-xl hover:bg-charcoal/5 transition focus:outline-none">
                ...
                <div className="h-8 w-8 rounded-full bg-charcoal text-white flex items-center justify-center text-xs font-bold shadow-sm">
                  JD
                </div>
            ...
            >
              ...
              <DropdownMenuItem className="text-sm font-medium py-2.5 cursor-pointer rounded-lg">
                Profile Settings
              </DropdownMenuItem>
              <DropdownMenuSeparator className="bg-charcoal/5" />
              <DropdownMenuItem
